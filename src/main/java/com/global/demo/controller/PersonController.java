...
import com.global.demo.data.PersonVO;
import com.global.demo.services.PersonServices;
...
public class PersonController {
        ...
        @Operation(summary = "Finds all People", description = "Endpoints for managing People", tags = {
                        "People" }, responses = {
        ...
        //Busca uma pessoa pelo seu nome
        ...
        // Cria uma pessoa
        @CrossOrigin(origins = { "http://localhost:3000", "https://globalSignature.com.br" })
        @PostMapping(consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE }, produces = {
                        MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
        @Operation(summary = "Adds a new Person", description = "Adds a new Person by passing a JSON e XML", tags = {
                        "People" }, responses = {
                                        @ApiResponse(description = "Sucess", responseCode = "200", content = @Content(schema = @Schema(implementation = PersonVO.class)
        ...
        @PutMapping(consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE }, produces = {
                        MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
        @Operation(summary = "Updates a Person", description = "Updates a Person by passing in a JSON e XML", tags = {
                        "People" }, responses = {
        ...
        @Operation(summary = "Deletes a Person", description = "Deletes a Person by passing in a JSON e XML", tags = {
                        "People" }, responses = {
