...
import com.global.demo.services.BookServices;
...
public class BookController {
			...
			"Book" }, responses = {
					@ApiResponse(description = "Sucess", responseCode = "200", content = {
							...
							@Content(
									...
									mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = BookVO.class)
	...
	@Operation(summary = "Deletes a Book", description = "Deletes a Book by passing in a JSON, XML representation of the book!", tags = {
			"Book" }, responses = {
					@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
